...
class TestConstructionFromAccount:
    def test_constructor_button(self, driver):
        ...
        driver.find_element(*StellarBurgersLocators.ACCOUNT_BUTTON_CONSTRUCTOR).click()
        assert WebDriverWait(driver, Data.WAIT_TIME).until(visible_order_button)
    ...
    def test_logo_button(self, driver):
        ...
        driver.find_element(*StellarBurgersLocators.ACCOUNT_BUTTON_LOGO).click()
        assert WebDriverWait(driver, Data.WAIT_TIME).until(visible_order_button)
